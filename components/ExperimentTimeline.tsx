...
export const experimentTimelineSteps = [
    ...
    },
    {
        ...
        desc: (
            <>
                <p className="text-sm text-gray-400">
                    Set up your experiment using Statsig. Define  <span className="font-medium text-blue-400">control</span> and  <span className="font-medium text-blue-400">variant</span> groups,  <span className="font-medium text-blue-400">target</span> the appropriate user segments,
                    and identify the key  <span className="font-medium text-blue-400">metrics</span> you'll analyze.
                </p>
                <p className="text-sm text-gray-400">Statsig handles random assignment and <span className="font-medium text-blue-400">exposure</span> logging once your groups are defined.</p>
                <br />
