...
import {
    FaChartBar, FaCheckCircle, FaCode, FaComments, FaEye,
    FaLightbulb, FaSlidersH
} from "react-icons/fa"
...
const steps = [
        ...
        desc: (
            <div>
                <p className="text-sm text-gray-400">
                    ...
                    Formulate a <span className="text-blue-400 font-medium">testable hypothesis</span> with a measurable outcome that helps you decide what success or failure looks like.
                </p>
                <br/>
                <p className="text-sm text-gray-400">
                🔍 Example Scenario
    ...
    },
    {
        ...
        desc: (
            <p className="text-sm text-gray-400">
                Set up your experiment using <span className="text-blue-400 font-medium">Statsig</span>.
                Define control and variant groups, target the appropriate user segments, and identify the key metrics you'll analyze.
            </p>
        ),
        icon: <FaSlidersH />,
    },
    {
        ...
        desc: (
            <p className="text-sm text-gray-400">
                Use Statsig's SDK to integrate the experiment.
                Call <code className="bg-base-200 px-1 py-0.5 rounded text-blue-400">{"getExperiment()"}</code> or <code className="bg-base-200 px-1 py-0.5 rounded text-blue-400">{"getConfig()"}</code> to control logic in your product based on user assignment.
            </p>
        ),
        icon: <FaCode />,
    },
    {
        ...
        desc: (
            <p className="text-sm text-gray-400">
                Ensure all <span className="text-blue-400 font-medium">exposure events</span> and relevant metrics are properly logged.
                This provides the data needed to evaluate your experiment's impact.
            </p>
        ),
        icon: <FaChartBar />,
    },
    {
        ...
        desc: (
            <p className="text-sm text-gray-400">
                Use Statsig's dashboard to watch experiment performance.
                Compare metrics between variants, look for <span className="text-blue-400 font-medium">significant differences</span>, and assess impact.
            </p>
        ),
        icon: <FaEye />,
    },
    {
        ...
        desc: (
            <p className="text-sm text-gray-400">
                Interpret the results. Decide whether to ship the change, roll it back, or iterate.
                Back your decision with <span className="text-blue-400 font-medium">data from the experiment</span>.
            </p>
        ),
        icon: <FaCheckCircle />,
    },
    {
        ...
        desc: (
            <p className="text-sm text-gray-400">
                Document the experiment's outcomes, insights, and decisions. Share findings with your team to support <span className="text-blue-400 font-medium">collective learning</span> and future initiatives.
            </p>
        ),
        icon: <FaComments />,
    },
            ...
            <div className="container mx-auto max-w-screen-xl px-4">
                ...
                <motion.div className="space-y-6 text-center" initial="hidden" whileInView="visible" variants={fadeInUp}>
                    ...
                    <div className="mt-6 text-sm text-gray-500">
                        ...
                        <a href="#challenges" className="mx-2 hover:underline">Challenges</a> |
                ...
                >
                    ...
                    <div className="mx-auto max-w-3xl text-center text-gray-400 space-y-6">
                        <p>
                            Atlassian lacked a scalable and intuitive experimentation platform. While most products had migrated to the cloud, the legacy of on-prem infrastructure left significant gaps in our ability to run controlled experiments effectively.
                            Experimentation was unintuitive, difficult to configure, and poorly supported—resulting in low adoption of feature flags and minimal experimentation across teams. UI tooling was fragmented and lacked usability, limiting experimentation velocity.
                        </p>
                        <p>
                        ...
                        <p className="text-white font-medium">
                            This project embraced a <span className="text-indigo-400 font-semibold">cloud-native mindset</span> to introduce standardized, developer-friendly tools—enabling fast, safe, and scalable experimentation.
                        </p>
                    </div>
                </motion.div>
                            ...
                            {steps.map((step, index) => (
                                ...
                                >
                                    ...
                                    <div className="timeline-middle">
                                        <div className="bg-base-200 rounded-full p-4 text-2xl text-white shadow-md">
                                            {step.icon}
                                        </div>
                                    </div>
                                    <div
                                        className={`${index % 2 === 0
                                            ? "timeline-start md:text-end mx-8 mb-12"
                                            : "timeline-end mx-8 mb-12"
                                            }`}
                                    >
                    ...
                    <div className="mx-auto max-w-4xl space-y-8">
                        <div className="card bg-base-200 p-6">
                            ...
                            <ul className="list-inside list-disc space-y-2 text-gray-400">
                                ...
                                <li>Integrated TAP (Traits and Attributes Platform) to enrich StatsigUser objects with org/user traits</li>
                                ...
                                <li>Enabled bootstrapping for latency-sensitive services to reduce P99 latency and avoid runtime dependencies</li>
                                <li>Handled merge conflicts between request headers, tokens, and developer overrides using a structured resolution order</li>
